...
/* package hilbert-engine-0.1.0.0 */
#define VERSION_hilbert_engine "0.1.0.0"
#define MIN_VERSION_hilbert_engine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hilbert-engine-0.1.0.0"

#define CURRENT_PACKAGE_KEY "hilbert-engine-0.1.0.0"
